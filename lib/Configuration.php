...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.pay.jp';
     ...
     * @var string
     */
    protected $userAgent = 'payjp/payjpv2 PHPBindings/1.0.1';
    ...
    /**
     * Builds X-Payjp-Client-User-Agent header value
     *
     * @return string JSON encoded client user agent info
     */
    ...
    {
        $report = 'PHP SDK (PAYJPV2) Debug Report:' . PHP_EOL;
