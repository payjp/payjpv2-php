...
class PaymentRefundResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets paymentFlow
     *
     * @param string $paymentFlow 返金対象となる PaymentFlow の ID
     *
     * @return self
     */
    public function setPaymentFlow(string $paymentFlow): self
    {
        if (is_null($paymentFlow)) {
            throw new \InvalidArgumentException('non-nullable paymentFlow cannot be null');
        }
