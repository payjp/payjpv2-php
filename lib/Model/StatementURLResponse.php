...
/**
 * StatementURLResponse Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class StatementURLResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatementURLResponse';
    ...
    public const OBJECT_STATEMENT_URL = 'statement_url';
    ...
    {
        $this->setIfExists('object', $data ?? [], 'statement_url');
    ...
    */
     ...
     * Sets url
     *
     * @param string $url 取引明細書ダウンロード URL
     *
     * @return self
     */
