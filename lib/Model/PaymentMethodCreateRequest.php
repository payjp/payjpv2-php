...
/**
 * PaymentMethodCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodCreateRequest';
    ...
    protected static $openAPITypes = [
        'customer' => 'string',
        'billingDetails' => '\PAYJPV2\Model\PaymentMethodBillingDetailsRequest',
    ...
    */
     ...
     * Gets billingDetails
     *
     * @return \PAYJPV2\Model\PaymentMethodBillingDetailsRequest
     */
    public function getBillingDetails(): \PAYJPV2\Model\PaymentMethodBillingDetailsRequest
    {
     ...
     * Sets billingDetails
     *
     * @param \PAYJPV2\Model\PaymentMethodBillingDetailsRequest $billingDetails 請求先情報
     *
     * @return self
     */
    public function setBillingDetails(\PAYJPV2\Model\PaymentMethodBillingDetailsRequest $billingDetails): self
    {
     ...
     * Gets card
     *
     * @return \PAYJPV2\Model\PaymentMethodCreateCardDetailsRequest
     */
     ...
     * Sets card
     *
     * @param \PAYJPV2\Model\PaymentMethodCreateCardDetailsRequest $card カード情報
     *
     * @return self
     */
    public function setCard(\PAYJPV2\Model\PaymentMethodCreateCardDetailsRequest $card): self
    {
        if (is_null($card)) {
