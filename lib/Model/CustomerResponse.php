...
class CustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['defaultPaymentMethod'] === null) {
            $invalidProperties[] = "'defaultPaymentMethod' can't be null";
        }
     ...
     *
     * @param string|null $defaultPaymentMethod defaultPaymentMethod
     *
     * @return self
     */
    public function setDefaultPaymentMethod(?string $defaultPaymentMethod): self
    {
        if (is_null($defaultPaymentMethod)) {
            array_push($this->openAPINullablesSetToNull, 'defaultPaymentMethod');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('defaultPaymentMethod', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
