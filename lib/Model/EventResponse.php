...
class EventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'pendingWebhooks' => 'setPendingWebhooks',
        'data' => 'setData',
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'pendingWebhooks' => 'getPendingWebhooks',
        'data' => 'getData',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pendingWebhooks', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pendingWebhooks'] === null) {
            $invalidProperties[] = "'pendingWebhooks' can't be null";
        }
    ...
    /**
     * Sets pendingWebhooks
     *
     * @param int $pendingWebhooks 設定された URL への通知が完了していない (2xx のレスポンスが得られていない) webhook の数
     *
     * @return self
     */
    public function setPendingWebhooks(int $pendingWebhooks): self
    {
        if (is_null($pendingWebhooks)) {
            throw new \InvalidArgumentException('non-nullable pendingWebhooks cannot be null');
        }
        $this->container['pendingWebhooks'] = $pendingWebhooks;
