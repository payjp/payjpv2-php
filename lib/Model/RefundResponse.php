...
class RefundResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_intent'] === null) {
            $invalidProperties[] = "'payment_intent' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id 返金対象となる PaymentIntent の ID
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at 作成時の日時 (UTC, ISO 8601 形式)
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \PAYJPV2\Model\PaymentRefundStatus $status 返金ステータス  <a href=\"https://docs.pay.jp/v2/refunds#refund_status\" target=\"_blank\">返金ステータスの詳細についてはこちらを参照してください。</a>  | 指定できる値 | |:---| | **succeeded**: 成功 | | **failed**: 失敗 | | **pending**: 保留中 | | **canceled**: キャンセル |
     *
     * @return self
     */
     ...
     * Sets payment_intent
     *
     * @param string $payment_intent 返金対象となる PaymentIntent の ID
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \PAYJPV2\Model\PaymentRefundReason
     */
     ...
     * Sets reason
     *
     * @param \PAYJPV2\Model\PaymentRefundReason $reason reason
     *
     * @return self
     */
