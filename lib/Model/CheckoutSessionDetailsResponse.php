...
class CheckoutSessionDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'lineItems' => '\PAYJPV2\Model\CheckoutSessionLineItemsResponse',
        'successUrl' => 'string',
        'url' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('setupFlow', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['billingAddressCollection'] === null) {
            $invalidProperties[] = "'billingAddressCollection' can't be null";
        }
        ...
        if ($this->container['setupFlow'] === null) {
            $invalidProperties[] = "'setupFlow' can't be null";
        }
     ...
     *
     * @param \PAYJPV2\Model\BillingAddressCollection|null $billingAddressCollection billingAddressCollection
     *
     * @return self
     */
    public function setBillingAddressCollection(?\PAYJPV2\Model\BillingAddressCollection $billingAddressCollection): self
    {
        if (is_null($billingAddressCollection)) {
            array_push($this->openAPINullablesSetToNull, 'billingAddressCollection');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billingAddressCollection', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     */
    public function getCustomer(): ?\PAYJPV2\Model\Customer
    {
     ...
     * @return self
     */
    public function setCustomer(?\PAYJPV2\Model\Customer $customer): self
    {
        if (is_null($customer)) {
     ...
     *
     * @param array<string,mixed>|null $customerDetails `expand` パラメーターを指定した場合、顧客の詳細情報を含んだオブジェクトが返却されます。  | 説明 | |:---| | **email**: 顧客のメールアドレス |
     *
     * @return self
     */
     ...
     */
    public function getPaymentFlow(): ?\PAYJPV2\Model\PaymentFlow
    {
     ...
     * Sets paymentFlow
     *
     * @param \PAYJPV2\Model\PaymentFlow|null $paymentFlow paymentFlow
     *
     * @return self
     */
    public function setPaymentFlow(?\PAYJPV2\Model\PaymentFlow $paymentFlow): self
    {
        if (is_null($paymentFlow)) {
            array_push($this->openAPINullablesSetToNull, 'paymentFlow');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('paymentFlow', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     */
    public function getSetupFlow(): ?\PAYJPV2\Model\SetupFlow
    {
        return $this->container['setupFlow'];
    }

    /**
     * Sets setupFlow
     *
     * @param \PAYJPV2\Model\SetupFlow|null $setupFlow setupFlow
     *
     * @return self
     */
    public function setSetupFlow(?\PAYJPV2\Model\SetupFlow $setupFlow): self
    {
        if (is_null($setupFlow)) {
            array_push($this->openAPINullablesSetToNull, 'setupFlow');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('setupFlow', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['setupFlow'] = $setupFlow;
     ...
     */
    public function getLineItems(): ?\PAYJPV2\Model\CheckoutSessionLineItemsResponse
    {
     ...
     * Sets lineItems
     *
     * @param \PAYJPV2\Model\CheckoutSessionLineItemsResponse|null $lineItems lineItems
     *
     * @return self
     */
    public function setLineItems(?\PAYJPV2\Model\CheckoutSessionLineItemsResponse $lineItems): self
    {
