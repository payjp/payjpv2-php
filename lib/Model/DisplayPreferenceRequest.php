...
/**
 * DisplayPreferenceRequest Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class DisplayPreferenceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisplayPreferenceRequest';
    ...
    public const PREFERENCE_NONE = 'none';
    public const PREFERENCE_OFF = 'off';
    public const PREFERENCE_ON = 'on';
    ...
    */
     ...
     * Sets preference
     *
     * @param string $preference この支払い方法がアカウントで有効になっているかどうか。  | 指定できる値 | |:---| | **on**: この決済手段を決済画面に表示する | | **off**: この決済手段を決済画面に表示しない | | **none**: デフォルト設定を使用 |
     *
     * @return self
     */
