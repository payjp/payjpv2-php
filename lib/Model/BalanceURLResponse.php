...
/**
 * BalanceURLResponse Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class BalanceURLResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BalanceURLResponse';
    ...
    public const OBJECT_BALANCE_URL = 'balance_url';
    ...
    {
        $this->setIfExists('object', $data ?? [], 'balance_url');
