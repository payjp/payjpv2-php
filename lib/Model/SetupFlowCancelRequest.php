...
/**
 * SetupFlowCancelRequest Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class SetupFlowCancelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetupFlowCancelRequest';
    ...
    protected static $openAPITypes = [
        'cancellation_reason' => '\PAYJPV2\Model\SetupFlowCancellationReason'
    ];
    ...
    */
     ...
     *
     * @param \PAYJPV2\Model\SetupFlowCancellationReason|null $cancellation_reason この SetupFlow のキャンセル理由。  | 指定できる値 | |:---| | **abandoned**: 顧客が支払いを完了しなかった場合。 | | **requested_by_customer**: 顧客がキャンセルを要求した場合。 | | **duplicate**: 支払い方法が重複している場合。 |
     *
     * @return self
     */
