...
class ProductCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets default_price
     *
     * @param string|null $default_price この商品のデフォルト価格である価格オブジェクトのID。
     *
     * @return self
     */
     ...
     * Sets unit_label
     *
     * @param string|null $unit_label この製品の単位を表すラベル。設定すると、Checkoutや請求書などに表示されます。（例：「個」、「ライセンス」、「時間」、「回」など）
     *
     * @return self
     */
    public function setUnitLabel($unit_label)
    {
        if (is_null($unit_label)) {
            throw new \InvalidArgumentException('non-nullable unit_label cannot be null');
        }
