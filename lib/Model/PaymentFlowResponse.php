...
/**
 * PaymentFlowResponse Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class PaymentFlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentFlowResponse';
    ...
    */
     ...
     *
     * @param int|null $amountCapturable amountCapturable
     *
     * @return self
     */
    public function setAmountCapturable(?int $amountCapturable): self
    {
        if (is_null($amountCapturable)) {
            array_push($this->openAPINullablesSetToNull, 'amountCapturable');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('amountCapturable', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets amountReceived
     *
     * @param int|null $amountReceived amountReceived
     *
     * @return self
     */
    public function setAmountReceived(?int $amountReceived): self
    {
        if (is_null($amountReceived)) {
            array_push($this->openAPINullablesSetToNull, 'amountReceived');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('amountReceived', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param array<string,mixed>|null $lastPaymentError lastPaymentError
     *
     * @return self
     */
    public function setLastPaymentError(?array $lastPaymentError): self
    {
        if (is_null($lastPaymentError)) {
            array_push($this->openAPINullablesSetToNull, 'lastPaymentError');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lastPaymentError', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
