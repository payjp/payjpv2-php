...
class PaymentMethodResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if ($this->container['detachedAt'] === null) {
            throw new \LogicException('Property "detachedAt" is required but has not been set.');
        }
     ...
     * Sets detachedAt
     *
     * @param \DateTime $detachedAt detachedAt
     *
     * @return self
     */
    public function setDetachedAt(\DateTime $detachedAt): self
    {
        if (is_null($detachedAt)) {
            throw new \InvalidArgumentException('non-nullable detachedAt cannot be null');
        }
