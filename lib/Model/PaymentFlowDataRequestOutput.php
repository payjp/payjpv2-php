...
/**
 * PaymentFlowDataRequestOutput Class Doc Comment
 *
 * @category Class
 * @package  PAYJPV2
 * @author   OpenAPI Generator team
 ...
 */
class PaymentFlowDataRequestOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentFlowDataRequest-Output';
    ...
    protected static $openAPITypes = [
        ...
        'meta_data' => 'array<string,\PAYJPV2\Model\MetadataValue>',
    ...
    */
     ...
     * Sets meta_data
     *
     * @param array<string,\PAYJPV2\Model\MetadataValue>|null $meta_data キーバリューの任意のデータを格納できます。<a href=\"https://docs.pay.jp/v2/metadata\">詳細はメタデータのドキュメントを参照してください。</a>
     *
     * @return self
     */
