...
class ProductDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['defaultPrice'] === null) {
            $invalidProperties[] = "'defaultPrice' can't be null";
        }
     ...
     * Sets defaultPrice
     *
     * @param string|null $defaultPrice defaultPrice
     *
     * @return self
     */
    public function setDefaultPrice(?string $defaultPrice): self
    {
        if (is_null($defaultPrice)) {
            array_push($this->openAPINullablesSetToNull, 'defaultPrice');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('defaultPrice', $nullablesSetToNull);
            if ($index !== FALSE) {
