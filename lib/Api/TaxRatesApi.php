...
class TaxRatesApi
{
     ...
     * Create Tax Rate
     *
     * @param  \PAYJPV2\Model\TaxRateCreateRequest $tax_rate_create_request tax_rate_create_request (required)
     ...
     * Create Tax Rate
     *
     * @param  \PAYJPV2\Model\TaxRateCreateRequest $tax_rate_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createTaxRate'] to see the possible values for this operation
     *
     * @throws \PAYJPV2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \PAYJPV2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PAYJPV2\Model\TaxRateListResponse|\PAYJPV2\Model\ErrorResponse
     */
    public function getAllTaxRates($limit = 10, $offset = 0, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        list($response) = $this->getAllTaxRatesWithHttpInfo($limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \PAYJPV2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PAYJPV2\Model\TaxRateListResponse|\PAYJPV2\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllTaxRatesWithHttpInfo($limit = 10, $offset = 0, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        $request = $this->getAllTaxRatesRequest($limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTaxRatesAsync($limit = 10, $offset = 0, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        return $this->getAllTaxRatesAsyncWithHttpInfo($limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTaxRatesAsyncWithHttpInfo($limit = 10, $offset = 0, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllTaxRatesRequest($limit = 10, $offset = 0, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        ...
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling TaxRatesApi.getAllTaxRates, must be bigger than or equal to 0.');
        }
     ...
     *
     * @param  string $tax_rate_id tax_rate_id (required)
     * @param  \PAYJPV2\Model\TaxRateUpdateRequest $tax_rate_update_request tax_rate_update_request (required)
     ...
     * @return \PAYJPV2\Model\TaxRateDetailsResponse|\PAYJPV2\Model\ErrorResponse
     */
    public function updateTaxRate($tax_rate_id, $tax_rate_update_request, string $contentType = self::contentTypes['updateTaxRate'][0])
    {
        list($response) = $this->updateTaxRateWithHttpInfo($tax_rate_id, $tax_rate_update_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $tax_rate_id (required)
     * @param  \PAYJPV2\Model\TaxRateUpdateRequest $tax_rate_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateTaxRate'] to see the possible values for this operation
     *
     * @throws \PAYJPV2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PAYJPV2\Model\TaxRateDetailsResponse|\PAYJPV2\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTaxRateWithHttpInfo($tax_rate_id, $tax_rate_update_request, string $contentType = self::contentTypes['updateTaxRate'][0])
    {
        $request = $this->updateTaxRateRequest($tax_rate_id, $tax_rate_update_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxRateAsync($tax_rate_id, $tax_rate_update_request, string $contentType = self::contentTypes['updateTaxRate'][0])
    {
        return $this->updateTaxRateAsyncWithHttpInfo($tax_rate_id, $tax_rate_update_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxRateAsyncWithHttpInfo($tax_rate_id, $tax_rate_update_request, string $contentType = self::contentTypes['updateTaxRate'][0])
    {
        $returnType = '\PAYJPV2\Model\TaxRateDetailsResponse';
        $request = $this->updateTaxRateRequest($tax_rate_id, $tax_rate_update_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxRateRequest($tax_rate_id, $tax_rate_update_request, string $contentType = self::contentTypes['updateTaxRate'][0])
    {
        ...
        if ($tax_rate_update_request === null || (is_array($tax_rate_update_request) && count($tax_rate_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax_rate_update_request when calling updateTaxRate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($tax_rate_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($tax_rate_update_request));
            } else {
                $httpBody = $tax_rate_update_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
