...
class TaxRatesApi
{
     ...
     */
    public function getAllTaxRates($limit = 10, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        list($response) = $this->getAllTaxRatesWithHttpInfo($limit, $starting_after, $ending_before, $contentType);
        return $response;
    }
     ...
     */
    public function getAllTaxRatesWithHttpInfo($limit = 10, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        $request = $this->getAllTaxRatesRequest($limit, $starting_after, $ending_before, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTaxRatesAsync($limit = 10, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
        return $this->getAllTaxRatesAsyncWithHttpInfo($limit, $starting_after, $ending_before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTaxRatesAsyncWithHttpInfo($limit = 10, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllTaxRatesRequest($limit = 10, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getAllTaxRates'][0])
    {
